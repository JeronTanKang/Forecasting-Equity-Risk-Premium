# This code calculates and plots the individual SHAP feature contributions of the XGBoost model 
# over the forecast window for different horizons (h=1, 3, 6, 12).
# It accumulates the SHAP values for each feature over multiple rolling windows, 
